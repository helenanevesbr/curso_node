...
class AdminController{
    ...
    formulario_inclusao_noticia(req, res){
        res.render("admin/form_add_noticia", {validacao: {}, noticia : {}});
    }
    noticias_salvar(req, res){
